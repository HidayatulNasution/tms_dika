...
import RangeSearch from './range-search.vue'; 
import historyUpload from './history-upload.vue';
import mergedDb from './merged-db.vue';
import viewMerged from './view-merged.vue';
